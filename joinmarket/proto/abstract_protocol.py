...
class AbstractNPartyProtocol(object):
    ...
    def receive_event(self, event_received, nick=None, msgargs=[]):
        ...
        if allowed:
            ...
            #sending_events = self.get_sending_events()
            #if event_received in sending_events:
            #    self.send_msg(event_received, msgargs)
                #TODO may need to return more about success of send.
            return (True,)
